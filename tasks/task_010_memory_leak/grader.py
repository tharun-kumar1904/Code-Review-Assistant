"""Grader for task_010_memory_leak — Unbounded list memory leak."""

GOLD = {
    "bugs": ["memory leak", "unbounded", "list", "growing", "append", "clear", "gc", "memory"],
...
def _score_action(action, gold=None):
    ...
    actionable_words = ["fix", "limit", "clear", "bound", "deque", "maxlen", "prune", "cap"]
