"""Grader for task_004_tensor_shape — PyTorch tensor shape mismatch + device placement."""

GOLD = {
    "bugs": ["shape", "mismatch", "tensor", "device", "cuda", "cpu", "dimension", "size"],
...
def _score_action(action, gold=None):
    ...
    actionable_words = ["fix", "reshape", "view", "to", "device", "match", "ensure", "verify"]
