"""Grader for task_009_path_traversal — Path traversal in file download."""

GOLD = {
    "bugs": ["path traversal", "traversal", "directory traversal", "../", "lfi", "sanitize path"],
...
def _score_action(action, gold=None):
    ...
    actionable_words = ["fix", "sanitize", "validate", "resolve", "canonical", "restrict", "whitelist"]
