"""Grader for task_014_error_swallow — Bare except + silent None propagation in retry logic."""

GOLD = {
    "bugs": ["bare except", "except:", "swallow", "silent", "none", "error handling", "retry", "propagat"],
...
def _score_action(action, gold=None):
    ...
    actionable_words = ["fix", "catch", "specific", "log", "raise", "re-raise", "handle"]
