"""Grader for task_006_race_condition — Race condition in async counter."""

GOLD = {
    "bugs": ["race condition", "race", "concurrent", "async", "lock", "mutex", "atomic", "thread"],
...
def _score_action(action, gold=None):
    ...
    actionable_words = ["fix", "add", "lock", "mutex", "atomic", "synchronize", "await"]
