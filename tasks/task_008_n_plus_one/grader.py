"""Grader for task_008_n_plus_one — N+1 query performance problem."""

GOLD = {
    "bugs": ["n+1", "n plus one", "query", "eager", "lazy", "prefetch", "join", "select_related"],
...
def _score_action(action, gold=None):
    ...
    actionable_words = ["fix", "eager", "prefetch", "join", "batch", "optimize", "reduce"]
