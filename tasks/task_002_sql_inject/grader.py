"""Grader for task_002_sql_inject — SQL injection via f-string query."""

GOLD = {
    "bugs": ["sql injection", "injection", "sqli", "parameterized", "f-string", "sanitize"],
...
def _score_action(action, gold=None):
    ...
    actionable_words = ["fix", "add", "use", "replace", "parameterize", "sanitize", "escape", "bind"]
