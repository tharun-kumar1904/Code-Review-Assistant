"""Grader for task_011_type_confusion — String parameters used in arithmetic."""

GOLD = {
    "bugs": ["type", "string", "int", "integer", "cast", "convert", "typeerror", "arithmetic"],
...
def _score_action(action, gold=None):
    ...
    actionable_words = ["fix", "cast", "convert", "int(", "float(", "validate", "type check"]
