"""Grader for task_003_off_by_one — Off-by-one error plus bare except clause."""

GOLD = {
    "bugs": ["off-by-one", "off by one", "fencepost", "boundary", "bare except", "except:"],
...
def _score_action(action, gold=None):
    ...
    actionable_words = ["fix", "change", "use", "replace", "catch", "specific", "handle"]
